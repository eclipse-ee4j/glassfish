...
|EJB ${jakarta-ejb-api-version} Lite (Support for Local Container only) |X |X

|JTA ${jakarta-transaction-api-version} |X |X

|OSGi-based microkernel |X |X

|Java Web Technologies (Servlet ${jakarta-servlet-api-version}, JSP ${jakarta-pages-api-version}, JSF ${jsf-templating-version}, JSTL ${jstl-api-version}, EL ${jakarta-el-api-version}) |X |X

|Grizzly/Comet |X |X

|JPA ${eclipselink-version}, (EclipseLink), JDBC Connection Pooling |X |X
...
|Common Annotations for Java  ${jakarta-annotation-api-version} |X |X
...
|Bean Validation ${jakarta-validation-api-version} |X |X
