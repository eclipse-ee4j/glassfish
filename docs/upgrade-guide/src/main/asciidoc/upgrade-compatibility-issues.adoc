...
link:upgrading-legacy-installation.html#upgrading-clusters-and-node-agent-configurations[Upgrading Clusters and Node
...
See "link:ha-administration-guide/overview.html#abdaq[
...
* The link:reference-manual/create-ssl.html#create-ssl[`create-ssl`] subcommand has a new `--type`
parameter value, `network-listener`.
* The link:reference-manual/create-virtual-server.html#create-virtual-server[`create-virtual-server`] SUBcommand has a new
parameter, `--networklisteners`.
* The link:reference-manual/create-http-listener.html#create-http-listener[`create-http-listener`] subcommand adds a
...
link:upgrading-legacy-installation.html#upgrading-installations-that-use-nss-cryptographic-tokens[Upgrading Installations
