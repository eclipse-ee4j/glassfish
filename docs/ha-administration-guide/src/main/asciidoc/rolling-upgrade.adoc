...
xref:#abdim[Upgrading In a Single Cluster].
...
xref:#abdio[Upgrading Incompatible Applications].
...
applications compatible, see xref:#abdil[Application Compatibility].
