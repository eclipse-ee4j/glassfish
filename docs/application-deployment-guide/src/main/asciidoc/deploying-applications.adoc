...
* xref:#to-deploy-an-application-or-module-by-using-a-deployment-plan[To Deploy an Application or Module by Using a Deployment
Plan]
...
link:overview.html#naming-standards[Naming Standards].
...
{productName}, see link:overview.html#deployment-descriptors-and-annotations[Deployment Descriptors and
Annotations].
...
link:dd-elements.html#jsp-config[`jsp-config`].
...
"link:application-development-guide/java-clients.html#beakt[Developing Java Clients]" in {productName} Application Development Guide. This chapter includes
...
subelement of the link:dd-elements.html#java-web-start-access[`java-web-start-access`]
...
server log. For details about naming, see link:overview.html#naming-standards[Naming
Standards].
...
"link:application-development-guide/lifecycle-listeners.html#beamc[Developing Lifecycle Listeners]" in {productName} Application Development Guide.
...
their link:dd-elements.html#webservice-endpoint[`webservice-endpoint`] and
link:dd-elements.html#webservice-description[`webservice-description`] elements.
...
"link:application-development-guide/webservices.html#gaszn[Developing Web Services]" in {productName} Application Development Guide.
...
link:dd-elements.html#jdbc-connection-pool[`jdbc-connection-pool`].
