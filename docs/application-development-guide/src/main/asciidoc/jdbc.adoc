...
* xref:#statements[Statements]
* xref:#connections[Connections]
* xref:#connection-wrapping[Connection Wrapping]
* xref:#allowing-non-component-callers[Allowing Non-Component Callers]
...
* xref:#using-an-initialization-statement[Using an Initialization Statement]
* xref:#setting-a-statement-timeout[Setting a Statement Timeout]
* xref:#statement-leak-detection-and-leaked-statement-reclamation[Statement Leak Detection and Leaked Statement Reclamation]
* xref:#statement-caching[Statement Caching]
* xref:#statement-tracing[Statement Tracing]
...
* xref:#transparent-pool-reconfiguration[Transparent Pool Reconfiguration]
* xref:#disabling-pooling[Disabling Pooling]
* xref:#associating-connections-with-threads[Associating Connections with Threads]
* xref:#custom-connection-validation[Custom Connection Validation]
* xref:#sharing-connections[Sharing Connections]
* xref:#marking-bad-connections[Marking Bad Connections]
...
"link:administration-guide/jdbc.html#ablih[Administering Database Connectivity]" in {productName} Administration Guide.
...
* xref:#wrapping-connections[Wrapping Connections]
* xref:#obtaining-a-physical-connection-from-a-wrapped-connection[Obtaining a Physical Connection From a Wrapped Connection]
* xref:#GSDVG00509[Using the `Connection.unwrap()` Method]
...
link:transaction-service.html#the-transaction-manager-the-transaction-synchronization-registry-and-usertransaction[The Transaction Manager, the
