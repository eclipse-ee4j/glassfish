...
link:monitor.html#monitor[`monitor`(1)],
link:enable-monitoring.html#enable-monitoring[`enable-monitoring`(1)],
link:disable-monitoring.html#disable-monitoring[`disable-monitoring`(1)],
link:list.html#list[`list`(1)], link:get.html#get[`get`(1)],
