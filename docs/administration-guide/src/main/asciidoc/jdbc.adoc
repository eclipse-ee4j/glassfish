...
+
To see the current list of database products supported by {productName}, refer to the link:../release-notes/toc.html#GSRLN[{productName} Release Notes].
...
link:../performance-tuning-guide/toc.html#GSPTG[{productName} Performance Tuning
Guide].
...
For a list of the JDBC drivers currently supported by the {productName}, see the link:../release-notes/toc.html#GSRLN[{productName} Release
