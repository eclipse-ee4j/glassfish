...
* xref:#gihzx[About Application Deployment]
* xref:#giphm[About Assembly and Deployment Events]
* xref:#giifh[About Deployment Tools]
* xref:#gipud[Additional Information on Application Deployment]
...
{productName} deployment tools are described in xref:#giifh[About
Deployment Tools].

The following topics are addressed here:

* xref:#giptw[General Deployment Functionality]
* xref:#gihzc[Deployment Descriptors and Annotations]
* xref:#gikhs[Modules and Applications]
* xref:#gijla[Access to Shared Framework Classes]
* xref:#gihzk[Naming Standards]
* xref:#gkhhv[Module and Application Versions]
...
options. See xref:#beaee[JSR 88 Client] and xref:#giiel[JSR 88 Naming].
...
* xref:#beacv[Types of Modules]
* xref:#beacu[Module-Based Deployment]
* xref:#beacw[Application-Based Deployment]
...
* xref:#gjjfg[Portable Naming]
* xref:#giidg[JNDI Naming]
* xref:#beada[Directory Structure]
...
* xref:#gkhmg[Version Identifiers and Expressions]
* xref:#gkhmm[Choosing the Enabled Version]
* xref:#gkhob[Versioning Restrictions and Limitations]
...
naming, see xref:#gihzk[Naming Standards].
+
...
instructions, see xref:#gijla[Access to Shared Framework Classes].
...
* xref:#giijz[Administration Console]
* xref:#giijf[The `asadmin` Utility]
* xref:#giijq[NetBeans IDE]
* xref:#gikwq[Eclipse IDE]
* xref:#beaee[JSR 88 Client]
