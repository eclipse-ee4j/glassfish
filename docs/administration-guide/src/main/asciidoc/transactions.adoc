...
xref:jms.adoc#abljw[Administering the Java Message Service (JMS)].
...
xref:connectors.adoc#abllp[Administering EIS Connectivity].
...
* To configure the transaction service, use the link:reference-manual/set.html#set[`set`]
...
+
You can use the link:reference-manual/get.html#get[`get`] subcommand to list all the
...
link:reference-manual/freeze-transaction-service.html#freeze-transaction-service[`freeze-transaction-service`] subcommand.
...
link:reference-manual/rollback-transaction.html#rollback-transaction[`rollback-transaction`] subcommand.
+
...
link:reference-manual/unfreeze-transaction-service.html#unfreeze-transaction-service[`unfreeze-transaction-service`] subcommand.
...
link:reference-manual/create-jvm-options.html#create-jvm-options[`create-jvm-options`] subcommand. For example:
...
link:reference-manual/recover-transactions.html#recover-transactions[`recover-transactions`] subcommand.
...
xref:jdbc.adoc#ablih[Administering Database Connectivity]. For more
