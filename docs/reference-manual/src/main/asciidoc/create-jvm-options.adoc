...
necessary, use the
link:create-profiler.html#create-profiler[`create-profiler`(1)]
...
link:restart-domain.html#restart-domain[`restart-domain`(1)] command.
...
link:create-profiler.html#create-profiler[`create-profiler`(1)],
link:delete-jvm-options.html#delete-jvm-options[`delete-jvm-options`(1)],
link:list-jvm-options.html#list-jvm-options[`list-jvm-options`(1)],
