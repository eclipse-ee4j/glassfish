...
Persistence API, see
https://jakarta.ee/learn/docs/jakartaee-tutorial/current/persist/persistence-intro/persistence-intro.html[Persistence]
...
see https://jakarta.ee/learn/docs/jakartaee-tutorial/current/persist/persistence-intro/persistence-intro.html[Persistence]
in The Jakarta EE Tutorial.
...
For a list of the JDBC drivers currently supported by the {productName}, see the xref:release-notes.adoc[{productName} Release
...
and `asadmin undeploy` commands, see the xref:reference-manual.adoc#deploy[{productName} Reference Manual].
