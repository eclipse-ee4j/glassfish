...
link:reference-manual/list-threadpools.html#list-threadpools[`list-threadpools`] subcommand.
...
link:reference-manual/delete-threadpool.html#delete-threadpool[`delete-threadpool`] subcommand.
