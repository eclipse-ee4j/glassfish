...
`glassfish-application-client.xml` file. See link:dd-files.html#GSDPG00081[The
...
in a `glassfish-web.xml` file. See link:dd-files.html#GSDPG00078[The
...
`glassfish-resources.xml` file. See link:dd-files.html#GSDPG00083[The
...
link:overview.html#module-and-application-versions[Module and Application Versions].
