...
and Message Queue broker clusters, see "link:ha-administration-guide/jms.html#abdbk[Configuring
...
module.
+
See "link:application-deployment-guide/deploying-applications.html#deploying-a-connector-module[Deploying a Connector Module]" in {productName} Application Deployment Guide.
