...
help information is also available in the link:../reference-manual/toc.html#GSRFM[{productName} Reference Manual].
...
message-id::
  ...
  value, for example, `CORE5004`. All `SEVERE` and `WARNING` messages
  and some `INFO` messages from {productName} contain a message
  identifier. For more information, see the link:../error-messages-reference/toc.html#GSEMR[{productName} Error Message Reference].
thread-id::
  The numerical identifier of the thread that created the message.
thread-name::
  The name of the thread that created the message.
