...
Server Directory: C:\glassfish9\glassfish\domains\domain1
...
Restart Command:  C:\glassfish9\glassfish\domains\domain1\bin\domain1Service.exe
restart
...
install
Status Command: C:\glassfish9\glassfish\domains\domain1\bin\domain1Service.exe status
...
C:\glassfish9\glassfish\domains\domain1\PlatformServices.log
