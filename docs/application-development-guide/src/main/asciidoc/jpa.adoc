...
link:webservices.html#the-databinding-provider[The Databinding Provider].
+
...
1. Set up the datasource. See "link:administration-guide/jdbc.html#ablih[
...
7. Monitor the application. See "link:administration-guide/monitoring.html#ablur[
...
link:class-loaders.html#using-the-common-class-loader[Using the Common Class Loader]. The new
