...
xref:install-node.adoc#install-node[`install-node`(1)] subcommand.
====
...
`--installdir`::
  ...
  for example, `/export/glassfish9/`. If the directory does not exist,
...
sj03.example.com:/export/glassfish9
Installing glassfish2339538623689073993.zip into sj03.example.com:/export/glassfish9
Removing sj03.example.com:/export/glassfish9/glassfish2339538623689073993.zip
Fixing file permissions of all files under sj03.example.com:/export/glassfish9/bin
Successfully connected to gfuser@sj04.example.com using keyfile /home/gfuser
/.ssh/id_rsa
Copying /home/gfuser/glassfish2339538623689073993.zip (81395008 bytes) to
sj04.example.com:/export/glassfish9
Installing glassfish2339538623689073993.zip into sj04.example.com:/export/glassfish9
Removing sj04.example.com:/export/glassfish9/glassfish2339538623689073993.zip
Fixing file permissions of all files under sj04.example.com:/export/glassfish9/bin
