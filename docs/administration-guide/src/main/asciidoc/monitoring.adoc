...
link:reference-manual/dotted-names.html#dotted-names[`dotted-names`(5ASC)] help page.
...
You can also use the link:reference-manual/set.html#set[`set`] subcommand to enable
...
You can also use the link:reference-manual/set.html#set[`set`] subcommand to disable
monitoring for a module. Using the `set` command is not a dynamic
procedure, so you need to restart {productName} for your changes to
take effect.
...
link:reference-manual/disable-monitoring.html#disable-monitoring[`disable-monitoring`] subcommand.
+
Server restart is not required.
...
2. Request the monitoring data by using the link:reference-manual/monitor.html#monitor[`monitor`]
subcommand.
...
link:reference-manual/list.html#list[`list`] subcommand.
+
