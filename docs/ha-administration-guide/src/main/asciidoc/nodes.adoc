...
install-dir::
  ...
  `/export/glassfish9/`. If the {productName} software is installed
...
sj01        SSH    sj01.example.com   /export/glassfish9   pmd-i1
sj02        SSH    sj02.example.com   /export/glassfish9   pmd-i2
Command list-nodes-ssh executed successfully.
----
...
asadmin> list-nodes-ssh --long=true
NODE NAME   TYPE   NODE HOST          INSTALL DIRECTORY    REFERENCED BY
sj01        SSH    sj01.example.com   /export/glassfish9
sj02        SSH    sj02.example.com   /export/glassfish9   pmd-i2
Command list-nodes-ssh executed successfully.
...
install-dir::
  The full path to the parent of the base installation directory of the
  {productName} software on the host, for example,
  `/export/glassfish9/`. You may omit this option. The installation
...
cfg01               CONFIG   cfg01.example.com    /export/glassfish9   yml-i1
cfg02               CONFIG   cfg02.example.com    /export/glassfish9   yml-i2
Command list-nodes-config executed successfully.
----
...
NODE NAME           TYPE     NODE HOST           INSTALL DIRECTORY    REFERENCED BY
localhost-domain1   CONFIG   localhost           /export/glassfish9
cfg01               CONFIG   cfg01.example.com   /export/glassfish9
cfg02               CONFIG   cfg02.example.com   /export/glassfish9   yml-i2
Command list-nodes-config executed successfully.
