...
described in "link:ha-administration-guide/ssh-setup.html#windows-operating-system-settings[
...
"link:ha-administration-guide/ssh-setup.html#windows-operating-system-settings[Windows Operating System Settings]" in {productName} High Availability Administration Guide
