...
* xref:#glassfish-server-documentation-set[{productName} Documentation Set]
* xref:#related-documentation[Related Documentation]
* xref:#typographic-conventions[Typographic Conventions]
* xref:#symbol-conventions[Symbol Conventions]
...
* https://jakarta.ee/learn/docs/jakartaee-tutorial/current/[The Jakarta EE Tutorial].
