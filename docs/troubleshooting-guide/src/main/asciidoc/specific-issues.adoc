...
"link:administration-guide/domains.html#starting-and-stopping-a-domain[
...
"link:administration-guide/overview.html#administration-console[Administration Console]" in {productName} Administration Guide.
...
"link:application-deployment-guide/deploying-applications.html#beact[Deploying Applications]" in {productName} Application Deployment Guide. Also see the Administration
Console online help.
...
"link:installation-guide/uninstalling.html#ghmlt[Uninstalling GlassFish]"
