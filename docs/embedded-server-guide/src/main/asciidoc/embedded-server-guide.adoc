...
"link:application-deployment-guide/deploying-applications.html#beact[Deploying Applications]" in {productName} Application Deployment Guide.
...
deploying an application from a directory, see "link:application-deployment-guide/deploying-applications.html#to-deploy-an-application-or-module-in-a-directory-format[To
...
descriptions of the
link:reference-manual/deploy.html#deploy[`deploy`(1)] subcommand parameters.
...
For information about optional parameters you can set, see the
descriptions of the
link:reference-manual/deploy.html#deploy[`deploy`(1)] command parameters.
...
For more information, see "link:application-deployment-guide/overview.html#naming-standards[Naming Standards]" in
...
Console Online Help or "link:administration-guide.html#part-ii[Resources and Services
...
link:reference-manual/list-log-levels.html#list-log-levels[`list-log-levels`] subcommand.
