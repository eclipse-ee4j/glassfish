...
This document explains how to run applications with Embedded
{productName} and to develop applications in which
{productName} is embedded. This document is for software developers
who are developing applications to run with Embedded {productName},
whether for production deployments, cloud environments, or testing.
