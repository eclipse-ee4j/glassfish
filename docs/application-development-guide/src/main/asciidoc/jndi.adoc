...
modules, see xref:lifecycle-listeners.adoc#beamc[Developing Lifecycle
Listeners].
...
see xref:class-loaders.adoc#beade[Class Loaders].
...
descriptor files, see "link:application-deployment-guide/dd-elements.html#beaqi[Elements of the {productName}
