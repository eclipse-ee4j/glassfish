...
link:instances.html#types-of-glassfish-server-instances[Types of {productName} Instances].
...
* link:clusters.html#to-create-a-cluster[To Create a Cluster]
...
* link:clusters.html#to-preconfigure-nondefault-gms-configuration-settings[To Preconfigure Nondefault GMS Configuration Settings]
* link:clusters.html#to-create-a-cluster[To Create a Cluster]
* link:instances.html#to-create-an-instance-centrally[To Create an Instance Centrally]
* link:instances.html#to-create-an-instance-locally[To Create an Instance Locally]
====
...
* link:clusters.html#to-delete-a-cluster[To Delete a Cluster]
