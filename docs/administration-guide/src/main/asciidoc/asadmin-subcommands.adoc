...
xref:reference-manual.adoc#create-javamail-resource[`create-javamail-resource`]::
...
xref:reference-manual.adoc#delete-javamail-resource[`delete-javamail-resource`]::
...
xref:reference-manual.adoc#list-javamail-resources[`list-javamail-resources`]::
