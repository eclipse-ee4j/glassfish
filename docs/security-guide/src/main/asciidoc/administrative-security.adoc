...
first see xref:system-security.adoc#ablnk[Administering System Security].
...
The link:reference-manual/enable-secure-admin-principal.html#enable-secure-admin-principal[
...
You can use the link:reference-manual/disable-secure-admin-principal.html#disable-secure-admin-principal[`disable-secure-admin-principal`]
...
You can use the link:reference-manual/list-secure-admin-principals.html#list-secure-admin-principals[`list-secure-admin-principals`]
...
link:reference-manual/enable-secure-admin-internal-user.html#enable-secure-admin-internal-user[
...
You can use the link:reference-manual/disable-secure-admin-internal-user.html#disable-secure-admin-internal-user[`disable-secure-admin-internal-user`]
...
You can use the link:reference-manual/list-secure-admin-internal-users.html#list-secure-admin-internal-users[`list-secure-admin-internal-users`]
