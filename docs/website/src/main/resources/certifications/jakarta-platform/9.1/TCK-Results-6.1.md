...
```
    ...
    [junit] Tests run: 50, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.38 sec
```
...
TCK Result Summary:
```
 [mvn.test] Tests run: 1045, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 574.329 sec - in TestSuite
 [mvn.test] 
 [mvn.test] Results :
 [mvn.test] 
