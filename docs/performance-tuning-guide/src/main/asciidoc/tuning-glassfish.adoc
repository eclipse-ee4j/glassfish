...
Refer to "link:administration-guide/jdbc.html#ablih[Administering Database Connectivity]" in
...
information on LAO, see link:tuning-apps.html#configure-jdbc-resources-as-one-phase-commit-resources[Configure JDBC
