...
|Jakarta Security ${jakartaSecurityApiVersion} supporting OpenID Connect |X |X

|Jakarta JSON Processing ${jakartaJsonpApiVersion} |X |X

|Jakarta JSON Binding (JSON-B) ${jakartaJsonBindApiVersion} |X |X

|EJB ${jakartaEjbApiVersion} Lite (Support for Local Container only) |X |X

|JTA ${jakartaTransactionApiVersion} |X |X

|OSGi-based microkernel |X |X

|Java Web Technologies (Servlet ${jakartaServletApiVersion}, JSP ${jakartaPagesApiVersion}, JSF ${jsftemplatingVersion}, JSTL ${jstlApiVersion}, EL ${jakartaElApiVersion}) |X |X

|Grizzly/Comet |X |X

|JPA ${eclipselinkVersion}, (EclipseLink), JDBC Connection Pooling |X |X

|JDBC 4.0 |X |X

|Apache Derby ${derbyVersion} |X |X
...
|Common Annotations for Java ${jakartaAnnotationApiVersion} |X |X

|Dependency Injection for Java 2.0 |X |X

|Managed Beans 2.1 |X |X

|Interceptors ${jakartaInterceptorApiVersion} |X |X

|Jakarta Contexts and Dependency Injection (CDI) ${jakartaCdiApiVersion} |X |X

|Bean Validation ${jakartaValidationApiVersion} |X |X

|Jakarta RESTful Web Services  ${jakartaRestApiVersion} (Jersey) |X |X
...
|JAXB ${jakartaJaxbImplVersion} |X |-

|Implementing Java Web Services 1.4 |X |-

|Web Services Metadata for the Java Platform 2.1 |X |-

|JMS ${jakartaMessagingApiVersion} |X |-

|Jakarta Mail ${jakartaMailApiVersion} |X |-

|JACC 2.1 |X |-

|Java Authentication Service Provider Interface for Containers ${jakartaAuthenticationApiVersion} |X |-
