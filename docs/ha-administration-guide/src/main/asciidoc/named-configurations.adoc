...
* xref:#abdjl[About Named Configurations]
* xref:#abdjq[Creating, Listing, and Deleting Named Configurations]
* xref:#gkrgf[Modifying Properties for Named Configurations and Instances]
...
information about how to copy a configuration, see xref:#abdjr[To Create
...
* xref:#abdjr[To Create a Named Configuration]
* xref:#gkrgg[To List the Named Configurations in a Domain]
* xref:#abdju[To List the Targets of a Named Configuration]
* xref:#abdjv[To Delete a Named Configuration]
...
* xref:#gkrls[Properties for Port Numbers in a Named Configuration]
* xref:#fxxvk[To Modify a Named Configuration's Properties]
* xref:#abdjt[To Modify Port Numbers of an Instance]
...
property-name::
  ...
  available properties, see xref:#gkrls[Properties for Port Numbers in a
  Named Configuration].
