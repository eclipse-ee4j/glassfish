...
* xref:#beahn[Value Added Features]
* xref:#beahw[EJB Timer Service]
* xref:#beahx[Using Session Beans]
* xref:#beail[Using Read-Only Beans]
* xref:#beait[Using Message-Driven Beans]
...
* xref:#beaho[Read-Only Beans]
* xref:#beahp[The `pass-by-reference` Element]
* xref:#beahq[Pooling and Caching]
* xref:#beahu[Priority Based Scheduling of Remote Bean Invocations]
* xref:#beahv[Immediate Flushing]
...
usage guidelines, see xref:#beail[Using Read-Only Beans].
...
See the instructions below, in xref:#gktqo[To Deploy an EJB Timer to a Cluster].
Also refer to
...
* xref:#beahy[About the Session Bean Containers]
* xref:#beaib[Stateful Session Bean Failover]
* xref:#beaii[Session Bean Restrictions and Optimizations]
...
* xref:#beahz[Stateless Container]
* xref:#beaia[Stateful Container]
...
xref:#beaic[Choosing a Persistence Store].
...
* xref:#beaic[Choosing a Persistence Store]
* xref:#beaid[Enabling Checkpointing]
* xref:#beaih[Specifying Methods to Be Checkpointed]
...
* xref:#beaie[Server Instance and EJB Container Levels]
* xref:#beaif[Application and EJB Module Levels]
* xref:#beaig[SFSB Level]
...
level, see xref:#beaic[Choosing a Persistence Store].
...
* xref:#beaij[Optimizing Session Bean Performance]
* xref:#beaik[Restricting Transactions]
* xref:#glanq[EJB Singletons]
...
* xref:#beaim[Read-Only Bean Characteristics and Life Cycle]
* xref:#beain[Read-Only Bean Good Practices]
* xref:#beaio[Refreshing Read-Only Beans]
* xref:#beais[Deploying Read-Only Beans]
...
* xref:#beaip[Invoking a Transactional Method]
* xref:#beaiq[Refreshing Periodically]
* xref:#beair[Refreshing Programmatically]
...
* xref:#beaiu[Message-Driven Bean Configuration]
* xref:#beaiy[Message-Driven Bean Restrictions and Optimizations]
...
* xref:#beaiv[Connection Factory and Destination]
* xref:#beaiw[Message-Driven Bean Pool]
* xref:#beaix[Domain-Level Settings]
...
* xref:#beaiz[Pool Tuning and Monitoring]
* xref:#beaja[The `onMessage` Runtime Exception]
