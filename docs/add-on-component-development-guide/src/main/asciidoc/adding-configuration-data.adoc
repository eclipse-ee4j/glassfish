...
* xref:#gjrdv[How {productName} Stores Configuration Data]
* xref:#gjlop[Defining an Element]
* xref:#gjlpb[Defining an Attribute of an Element]
* xref:#gjlov[Defining a Subelement]
* xref:#gjlpu[Validating Configuration Data]
* xref:#gjrdj[Initializing a Component's Configuration Data]
* xref:#gjrcz[Creating a Transaction to Update Configuration Data]
* xref:#gjmkt[Dotted Names and REST URLs of Configuration Attributes]
* xref:#gkaal[Examples of Adding Configuration Data for a Component]
...
For more information, see xref:#gjlop[Defining an Element].
...
* xref:#gkbgi[To Define a Component's Initial Configuration Data]
* xref:#gjses[To Write a Component's Initial Configuration Data to the
`domain.xml` File]
