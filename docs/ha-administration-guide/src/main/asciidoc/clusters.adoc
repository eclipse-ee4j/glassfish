...
xref:instances.adoc#administering-glassfish-server-instances[Administering {productName} Instances].
...
xref:reference-manual.adoc#validate-multicast[`validate-multicast`(1)]
subcommand.
...
Below are sample xref:reference-manual.adoc#get[`get`] subcommands to get all the GMS
...
1. Create a configuration using the xref:reference-manual.adoc#copy-config[`copy-config`]
subcommand.
+
For example:
+
...
2. Use the xref:reference-manual.adoc#get[`get`] subcommand to determine the settings
to change.
+
For example:
+
...
For a complete list of the dotted names for these settings, see
xref:#dotted-names-for-gms-settings[Dotted Names for GMS Settings].
3. Use the xref:reference-manual.adoc#set[`set`] subcommand to change the settings.
+
For example:
+
[source]
...
running (as shown by the xref:reference-manual.adoc#list-instances[`list-instances`] subcommand),
...
xref:reference-manual.adoc#get-health[`get-health`] subcommand.
...
the xref:reference-manual.adoc#validate-multicast[`validate-multicast`] subcommand.
...
+
Use the xref:reference-manual.adoc#create-system-properties[`create-system-properties`] subcommand for this
purpose.
+
[source]
----
...
node-name::
  ...
  xref:nodes.adoc#administering-glassfish-server-nodes[Administering {productName} Nodes].
cluster-name::
...
* xref:reference-manual.adoc#create-system-properties[`create-system-properties`(1)]
...
cluster, see the xref:reference-manual.adoc#create-cluster[`create-cluster`(1)] help page.
====
...
* xref:reference-manual.adoc#create-cluster[`create-cluster`(1)]
* xref:reference-manual.adoc#create-system-properties[`create-system-properties`(1)]
...
+
Remote subcommands require a running server.
2. Run the xref:reference-manual.adoc#list-clusters[`list-clusters`] subcommand.
+
[source]
----
...
xref:reference-manual.adoc#list-clusters[`list-clusters`(1)]
...
cluster-name::
  The name of the cluster that you are deleting.
4. Run the xref:reference-manual.adoc#delete-cluster[`delete-cluster`] subcommand.
+
[source]
----
...
* xref:instances.adoc#to-delete-an-instance-centrally[To Delete an Instance Centrally]
* xref:instances.adoc#to-delete-an-instance-locally[To Delete an Instance Locally]
* xref:reference-manual.adoc#delete-cluster[`delete-cluster`(1)]
* xref:reference-manual.adoc#list-clusters[`list-clusters`(1)]
