...
deployment descriptors, see "link:application-deployment-guide/dd-elements.html#c-elements-of-the-glassfish-server-deployment-descriptors[Elements of the {productName} Deployment Descriptors]" in {productName}
...
see "link:application-deployment-guide/dd-elements.html#c-elements-of-the-glassfish-server-deployment-descriptors[Elements of the {productName} Deployment
...
"link:application-deployment-guide/dd-elements.html#c-elements-of-the-glassfish-server-deployment-descriptors[Elements of the {productName} Deployment
Descriptors]" in {productName} Application
Deployment Guide.
...
see "link:administration-guide/http_https.html#administering-internet-connectivity[Administering Internet Connectivity]" in {productName} Administration Guide.
