...
{productName} Release 9.1 requires Java 17 minimum and runs on JDK 17 to JDK 21, experimentally on higher versions.
{productName} Release 9.0 requires Java 11 minimum and runs on JDK 11 to JDK 21, experimentally on higher versions.
