...
* link:#gglqp[Configuring a DAS or a GlassFish Server Instance for Automatic Restart]
...
See "link:../ha-administration-guide/ssh-setup.html#GSHAG00003[Enabling Centralized Administration of GlassFish Server Instances]"
in GlassFish Server Open Source Edition High Availability Administration Guide for instructions.
