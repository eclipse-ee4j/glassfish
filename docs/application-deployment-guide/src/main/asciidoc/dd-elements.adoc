...
a|
xref:#prefaceetch-disabled[`prefetch-disabled`]
...
specific query methods, use a xref:#prefaceetch-disabled[`prefetch-disabled`] element
...
xref:#prefaceetch-disabled[`prefetch-disabled`] (`glassfish-ejb-jar.xml`)
