...
For more information, see the xref:add-on-component-development-guide.adoc[{productName} Add-On Component Development Guide].
...
xref:add-on-component-development-guide.adoc[{productName} Add-On Component
Development Guide]
