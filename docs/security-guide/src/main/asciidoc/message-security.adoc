...
policies, see "link:application-development-guide/securing-apps.html#securing-applications[Securing Applications]" in {productName} Application Development Guide.
...
application, "link:application-development-guide/securing-apps.html#securing-applications[
...
Use the link:reference-manual/set.html#set[`set`] subcommand to set the response policy,
...
by using the link:reference-manual/set.html#set[`set`] subcommand.
+
For example:
+
[source]
...
link:reference-manual/create-message-security-provider.html#create-message-security-provider[`create-message-security-provider`] subcommand.
+
...
"link:administration-guide/overview.html#configuration-changes-that-require-restart[Configuration Changes That Require Restart]" in
{productName} Administration Guide. If your
server needs to be restarted, see "link:administration-guide/domains.html#to-restart-a-domain[To Restart a
...
link:reference-manual/list-message-security-providers.html#list-message-security-providers[`list-message-security-providers`] subcommand.
...
using the link:reference-manual/set.html#set[`set`] subcommand.
+
...
link:reference-manual/delete-message-security-provider.html#delete-message-security-provider[`delete-message-security-provider`] subcommand.
...
* "link:application-development-guide/securing-apps.html#securing-applications[Securing Applications]"
