...
the xref:release-notes.adoc[{productName} Release Notes] for
...
Refer to the xref:release-notes.adoc[{productName} Release
...
* Release Notes: xref:release-notes.adoc[{productName}
Release Notes]
* Error messages: xref:error-messages-reference.adoc[{productName} Error
Message Reference]
