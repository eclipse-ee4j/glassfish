...
* xref:#beaox[Introducing Jakarta Mail]
* xref:#beaoy[Creating a Jakarta Mail Session]
* xref:#beaoz[Jakarta Mail Session Properties]
* xref:#beapa[Looking Up a Jakarta Mail Session]
* xref:#fwfiy[Sending and Reading Messages Using Jakarta Mail]
* xref:#gkpfg[Using Application-Scoped Jakarta Mail Resources]
...
* xref:#beapb[To Send a Message Using Jakarta Mail]
* xref:#beapc[To Read a Message Using Jakarta Mail]
...
Session session = (Session)ic.lookup(snName);
----
For more information, see xref:#beapa[Looking Up a Jakarta Mail Session].
