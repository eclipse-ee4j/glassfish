...
* xref:#gbizi[Creating Portable Web Service Artifacts]
* xref:#gbixz[Deploying a Web Service]
* xref:#gbiyw[The Web Service URI, WSDL File, and Test Page]
* xref:#CHDEBBCH[The Databinding Provider]
* xref:#gcgzz[GlassFish Jakarta EE Service Engine]
...
Specification Request (JSR) 222] and xref:#CHDEBBCH[The Databinding Provider].
