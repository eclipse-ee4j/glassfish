...
2. Use the link:reference-manual/list-log-attributes.html#list-log-attributes[`list-log-attributes`]
...
3. Use the link:reference-manual/set-log-attributes.html#set-log-attributes[`set-log-attributes`]
...
link:reference-manual/set-log-attributes.html#set-log-levels[`set-log-attributes`] subcommand,
...
link:reference-manual/redeploy.html#redeploy[`set-log-file-format`] subcommand.
...
2. Exclude fields by using the link:reference-manual/set-log-attributes.html#set-log-attributes[`set-log-attributes`]
...
link:reference-manual/set-log-attributes.html#set-log-attributes[`set-log-attributes`] subcommand,
...
the link:reference-manual/rotate-log.html#rotate-log[`rotate-log`] subcommand.
...
2. Use the link:reference-manual/collect-log-files.html#collect-log-files[`collect-log-files`] subcommand
