...
* xref:#gkrbn[Types of {productName} Instances]
* xref:#gkqal[Administering {productName} Instances Centrally]
* xref:#gkqdw[Administering {productName} Instances Locally]
* xref:#gkrdd[Resynchronizing {productName} Instances and the DAS]
* xref:#gkqcr[Migrating EJB Timers]
...
* xref:#gkqch[To Create an Instance Centrally]
* xref:#gkrcb[To List All Instances in a Domain]
* xref:#gkqcw[To Delete an Instance Centrally]
* xref:#gkqcj[To Start a Cluster]
* xref:#gkqcl[To Stop a Cluster]
* xref:#gkqaw[To Start an Individual Instance Centrally]
* xref:#gkqaj[To Stop an Individual Instance Centrally]
* xref:#gkqcc[To Restart an Individual Instance Centrally]
...
explained in xref:#gkqbl[To Create an Instance Locally].
...
* link:nodes.html#CHDIGBJB[To Create a `DCOM` Node]
* link:nodes.html#gkrnf[To Create an `SSH` Node]
* xref:#gkqbl[To Create an Instance Locally]
...
* xref:#gkqaw[To Start an Individual Instance Centrally]
* xref:#gkqci[To Stop an Individual Instance Locally]
...
each instance locally as explained in xref:#gkqak[To Start an Individual
Instance Locally].
...
* xref:#gkqak[To Start an Individual Instance Locally]
...
explained in xref:#gkqak[To Start an Individual Instance Locally].
...
xref:#gksbo[Default Synchronization for Files and Directories].

If you require different synchronization behavior, stop and start the
instance as explained in xref:#gksak[To Resynchronize an Instance and
the DAS Online].
...
* xref:#gkqbl[To Create an Instance Locally]
* xref:#gkqed[To Delete an Instance Locally]
* xref:#gkqak[To Start an Individual Instance Locally]
* xref:#gkqci[To Stop an Individual Instance Locally]
* xref:#gkqef[To Restart an Individual Instance Locally]
...
instances reside. For instructions, see xref:#gkrcb[To List All
Instances in a Domain].
====
...
instance. For more information, see xref:#gksak[To Resynchronize an
...
For more information, see xref:#gksaz[To Resynchronize Additional Configuration Files].
====
...
For instructions, see xref:#gksak[To Resynchronize an Instance and the DAS Online].

See Also

* xref:#gksak[To Resynchronize an Instance and the DAS Online]
...
* xref:#gkvwo[To Enable Automatic EJB Timer Migration for Failed Clustered Instances]
* xref:#abdji[To Migrate EJB Timers Manually]
