...
xref:dd-files.adoc#giida[{productName} Deployment Descriptor Files]
and xref:dd-elements.adoc#beaqi[Elements of the {productName}
...
xref:asadmin-deployment-subcommands.adoc#gihzw[The `asadmin` Deployment
