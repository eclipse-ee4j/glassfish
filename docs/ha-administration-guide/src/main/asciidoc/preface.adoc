...
|xref:quick-start-guide.adoc#GSQSG[Server Quick Start Guide] |Explains how to get started with the
{productName} Server.
...
|xref:security-guide.adoc#GSSCG[Server Security Guide] |Provides instructions for configuring and
...
|xref:troubleshooting-guide.adoc#GSTSG[Server Troubleshooting Guide] |Describes common problems that you
