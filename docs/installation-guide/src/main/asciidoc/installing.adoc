...
* xref:#gjiaz[Installation Requirements]
* xref:#ggrlg[Installation Files for {productName} 7]
* xref:#ghmxb[Installing {productName} From a ZIP File]
...
* xref:#gkbaj[{productName} Download Locations]
* xref:#gkbby[{productName} Installation Methods]
* xref:#gkudi[Choosing an Installation Method]
* xref:#gkbbb[{productName} ZIP Files]
...
|Multi-platform ZIP file |xref:#ghmxb[Installing {productName} From a ZIP File].
|===
...
* xref:#gkuau[ZIP Package]
* xref:#gkudp[Full Platform or Web Profile Distribution]
...
systems. See xref:#gkbaj[{productName} Download Locations] for a list
...
See xref:#gkbaj[{productName} Download Locations] for a list of
