...
You can use the link:list.html#list[`list`(1)] subcommand to display
...
using the link:set.html#set[`set`(1)] subcommand. For more detailed
...
link:list.html#list[`list`(1)], link:set.html#set[`set`(1)]
