...
* xref:#gilfm[Deploying Applications and Modules]
* xref:#gjiwk[Modifying the Configuration of a Web Application or
Module]
* xref:#beaej[Web Module Deployment Guidelines]
* xref:#beaek[EJB Module Deployment Guidelines]
* xref:#gilxc[Deploying a Connector Module]
* xref:#beaem[Assembling and Deploying an Application Client Module]
* xref:#beael[Lifecycle Module Deployment Guidelines]
* xref:#gbiye[Web Service Deployment Guidelines]
* xref:#gkkmb[OSGi Bundle Deployment Guidelines]
* xref:#gkoif[Transparent JDBC Connection Pool Reconfiguration]
* xref:#giydj[Application-Scoped Resources]
...
* xref:#gijmq[To Deploy an Application or Module]
* xref:#gijrc[To Change Targets for a Deployed Application or Module]
* xref:#giulr[To List Deployed Applications or Modules]
* xref:#gijmb[To Redeploy an Application or Module]
* xref:#fvyje[To Disable an Application or Module]
* xref:#gijjy[To Enable an Application or Module]
* xref:#gijkl[To Undeploy an Application or Module]
* xref:#fwakh[To Reload Changes to Applications or Modules Dynamically]
* xref:#fvxze[To Deploy an Application or Module Automatically]
* xref:#gijyb[To Deploy an Application or Module by Using a Deployment
Plan]
* xref:#gilcn[To Deploy an Application or Module in a Directory Format]
...
directory. For instructions, see xref:#fwakh[To Reload Changes to
...
* xref:#giyce[To Set a Web Context Parameter]
* xref:#giycy[To Unset a Web Context Parameter]
* xref:#giybo[To List Web Context Parameters]
* xref:#giyhc[To Set a Web Environment Entry]
* xref:#giyjr[To Unset a Web Environment Entry]
* xref:#giyip[To List Web Environment Entries]
...
* xref:#fvynl[To Deploy and Configure a Stand-Alone Connector Module]
* xref:#bealp[Redeploying a Stand-Alone Connector Module]
* xref:#bealq[Deploying and Configuring an Embedded Resource Adapter]
...
see xref:#giydj[Application-Scoped Resources].
...
* xref:#fvyal[To Assemble and Deploy an Application Client]
* xref:#fwahd[To Prepare Another Machine for Running an Application
Client]
* xref:#gavpv[To Undeploy an Application Client]
...
+
Instructions are contained in xref:#gijmq[To Deploy an Application or
Module].
