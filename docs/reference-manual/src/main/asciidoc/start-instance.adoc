...
This subcommand requires the secure shell (SSH) to be configured on the machine
...
instance Location: /export/glassfish9/glassfish/nodes/localhost/pmdsa1
Log File: /export/glassfish9/glassfish/nodes/localhost/pmdsa1/logs/server.log
Admin Port: 24848
...
instance Location: /export/glassfish9/glassfish/nodes/localhost/ymlsa1
Log File: /export/glassfish9/glassfish/nodes/localhost/ymlsa1/logs/server.log
Admin Port: 24849
