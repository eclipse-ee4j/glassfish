...
"link:application-deployment-guide/dd-elements.html#pass-by-reference[pass-by-reference]" in {productName} Application Deployment Guide.
...
described in "link:application-deployment-guide/dd-elements.html#bean-cache[bean-cache]" in {productName} Application Deployment Guide.
...
link:transaction-service.html#commit-options[Commit Options].
...
"link:application-deployment-guide/dd-elements.html#flush-at-end-of-method[flush-at-end-of-method]" in {productName} Application Deployment Guide.
...
drivers, see "link:administration-guide/jdbc.html#configuration-specifics-for-jdbc-drivers[Configuration Specifics for JDBC
...
Also refer to
"link:administration-guide/jdbc.html#enabling-the-jdbc__default-resource-in-a-clustered-environment[Enabling the jdbc/__default Resource in a Clustered Environment]"
...
path. For more information, see link:webapps.html#configuring-idempotent-url-requests[Configuring
...
link:webapps.html#distributed-sessions-and-persistence[Distributed Sessions and Persistence].
...
For details, see "link:application-deployment-guide/dd-elements.html#checkpoint-at-end-of-method[checkpoint-at-end-of-method]" in
...
beans, see link:jms.html#load-balanced-message-inflow[Load-Balanced Message Inflow].
