...
* xref:#how-glassfish-server-provides-high-availability[How {productName} Provides High Availability]
...
link:http-load-balancing.html#configuring-glassfish-server-with-apache-http-server-and-mod_jk[Configuring {productName} with
Apache HTTP Server and `mod_jk`] and
link:http-load-balancing.html#configuring-glassfish-server-with-apache-http-server-and-mod_proxy_ajp[Configuring {productName} with
...
Message Queue Broker Clusters::
  ...
  link:jms.html#using-message-queue-broker-clusters-with-glassfish-server[Using Message Queue Broker Clusters With {productName}].
Connection Failover::
  ...
  link:jms.html#connection-failover[Connection Failover].
...
* xref:#storage-for-session-state-data[Storage for Session State Data]
* xref:#highly-available-clusters[Highly Available Clusters]
...
see link:rolling-upgrade.html#upgrading-in-multiple-clusters[Upgrading in Multiple Clusters].
...
* xref:#recovering-glassfish-server-instances[Recovering {productName} Instances]
...
"link:administration-guide/domains.html#re-creating-the-domain-administration-server-das[Re-Creating the Domain Administration Server (DAS)]"
...
{productName} provide tools for backing up and restoring {productName} instances. For more information, see link:instances.html#to-resynchronize-an-instance-and-the-das-offline[To
