...
* xref:#gkpay[Overview of OSGi Application and {productName}]
* xref:#gkqff[Developing OSGi Application Bundles for {productName}]
* xref:#gkveh[Deploying OSGi Bundles in {productName}]
...
applications. See xref:#glhek[Benefits of Using OSGi in Enterprise Java
...
components. See xref:#gkupd[Developing Plain OSGi Bundles].
...
** Web Application Bundles (or WABs) , see xref:#gkunr[Developing Web
Application Bundles].

** EJB Application Bundles, see xref:#gkunh[Developing EJB Application
Bundles].
...
* xref:#gkupd[Developing Plain OSGi Bundles]
* xref:#gkunr[Developing Web Application Bundles]
* xref:#gkunh[Developing EJB Application Bundles]
...
* xref:#gkunk[HTTP Service]
* xref:#gkunn[Transaction Service]
* xref:#gkuof[JDBC Data Source Service]
* xref:#gkuoq[JMS Resource Service]
...
To learn more about this feature, refer to xref:#gkvbi[OSGi CDI
Extension for WABs].
...
To learn more about this feature, refer to xref:#gkvbj[Using the OSGi
