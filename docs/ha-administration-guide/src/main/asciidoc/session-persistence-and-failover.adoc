...
link:overview.html#high-availability-session-persistence[High Availability Session Persistence].
====
...
in link:overview.html#high-availability-session-persistence[High Availability Session Persistence].
...
+
For more information, see link:clusters.html#to-create-a-cluster[To Create a Cluster].

2. Set up load balancing for the cluster.
+
For instructions, see link:http-load-balancing.html#setting-up-http-load-balancing[Setting Up HTTP Load Balancing].
...
+
For more information, see "link:application-deployment-guide/deploying-applications.html#web-module-deployment-guidelines[Web Module Deployment
