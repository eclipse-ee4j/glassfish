...
a|xref:deployment-planning-guide.adoc[
...
a|xref:installation-guide.adoc[
...
* xref:application-deployment-guide.adoc[
{productName} Application Deployment Guide]
* xref:administration-guide.adoc[
...
a|xref:ha-administration-guide.adoc[
...
"xref:security-guide.adoc#administering-authentication-realms[Administering Authentication Realms]" in {productName} Server Security Guide.
...
See the xref:ha-administration-guide.adoc[{productName} High
...
xref:administration-guide.adoc[{productName} Administration Guide].
...
configurations, see the xref:ha-administration-guide.adoc[{productName}
