...
* xref:#beafd[Enabling Debugging]
* xref:#beafe[JPDA Options]
* xref:#beaff[Generating a Stack Trace for Debugging]
* xref:#gekvq[Application Client Debugging]
* xref:#beafk[Open Message Queue Debugging]
* xref:#beafl[Enabling Verbose Mode]
* xref:#gkpdk[Class Loader Debugging]
* xref:#beafm[{productName} Logging]
* xref:#beafn[Profiling Tools]
...
Options. See xref:#beafe[JPDA Options].
...
* xref:#gcicc[The NetBeans Profiler]
* xref:#beafo[The HPROF Profiler]
* xref:#beafr[The JProbe Profiler]
