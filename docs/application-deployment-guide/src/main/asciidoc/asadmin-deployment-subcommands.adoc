...
see "xref:administration-guide.adoc#asadmin-subcommands[Subcommands for the `asadmin` Utility]" in
{productName} Administration Guide or see the
xref:reference-manual.adoc[{productName} Reference Manual].

xref:reference-manual.adoc#add-library[`add-library`]::
...
xref:reference-manual.adoc#create-application-ref[`create-application-ref`]::
...
xref:reference-manual.adoc#delete-application-ref[`delete-application-ref`]::
...
xref:reference-manual.adoc#deploy[`deploy`]::
  ...
  Module].
xref:reference-manual.adoc#deploydir[`deploydir`]::
  This subcommand is deprecated. Use the `deploy` subcommand instead.
xref:reference-manual.adoc#disable[`disable`]::
  ...
  Module].
xref:reference-manual.adoc#enable[`enable`]::
...
xref:reference-manual.adoc#get-client-stubs[`get-client-stubs`]::
  ...
  Guidelines].
xref:reference-manual.adoc#list-applications[`list-applications`]::
  ...
  Modules].
xref:reference-manual.adoc#list-application-refs[`list-application-refs`]::
  Lists Jakarta EE applications and modules deployed on the specified
  target server instance or cluster.
xref:reference-manual.adoc#list-libraries[`list-libraries`]::
...
xref:reference-manual.adoc#list-components[`list-components`]::
  This subcommand is deprecated. Use the `list-applications` subcommand
  instead.
xref:reference-manual.adoc#list-sub-components[`list-sub-components`]::
  ...
  xref:deploying-applications.adoc#to-list-deployed-applications-or-modules[To List Deployed Applications or
  Modules].
xref:reference-manual.adoc#list-web-context-param[`list-web-context-param`]::
  ...
  Context Parameters].
xref:reference-manual.adoc#list-web-env-entry[`list-web-env-entry`]::
  ...
  Entries].
xref:reference-manual.adoc#redeploy[`redeploy`]::
  ...
  Module].
xref:reference-manual.adoc#remove-library[`remove-library`]::
  ...
  directory, the Java optional package directory, or the
  application-specific class loader directory.
xref:reference-manual.adoc#set-web-context-param[`set-web-context-param`]::
  ...
  Context Parameter].
xref:reference-manual.adoc#set-web-env-entry[`set-web-env-entry`]::
...
xref:reference-manual.adoc#undeploy[`undeploy`]::
  ...
  Module].
xref:reference-manual.adoc#unset-web-context-param[`unset-web-context-param`]::
  ...
  Context Parameter].
xref:reference-manual.adoc#unset-web-env-entry[`unset-web-env-entry`]::
