...
* xref:#ghokq[HK2 Component Model]
* xref:#ghojt[Services in the HK2 Component Model]
* xref:#ghokt[HK2 Runtime]
* xref:#ghojb[Inversion of Control]
* xref:#ghmoe[Identifying a Class as an Add-On Component]
* xref:#ghpvp[Using the Apache Maven Build System to Develop HK2 Components]
