...
* link:#gkofe[Considerations When Running GlassFish Server With Default Security]
...
administration traffic or impersonate legitimate GlassFish Server components.
