...
host. The entire content of the `/export/glassfish9` directory is
removed.
...
[source]
----
asadmin> uninstall-node-ssh --force --installdir /export/glassfish9 sj02.example.com
Successfully connected to gfuser@sj02.example.com using keyfile /home/gfuser
/.ssh/id_rsa
Force removing file /export/glassfish9/mq/lib/help/en/add_overrides.htm
Force removing file /export/glassfish9/mq/lib/help/en/add_connfact.htm
...
Force removing directory /export/glassfish9/glassfish/lib/appclient
Force removing directory /export/glassfish9/glassfish/lib
Force removing directory /export/glassfish9/glassfish
Command uninstall-node-ssh executed successfully.
----
