...
* xref:#ghprc[Integration Point Attributes]
* xref:#ghmwa[`org.glassfish.admingui:navNode` Integration Point]
* xref:#gjkff[`org.glassfish.admingui:rightPanel` Integration Point]
* xref:#gjkfq[`org.glassfish.admingui:rightPanelTitle` Integration Point]
* xref:#ghpkh[`org.glassfish.admingui:serverInstTab` Integration Point]
* xref:#ghpit[`org.glassfish.admingui:commonTask` Integration Point]
* xref:#ghphz[`org.glassfish.admingui:configuration` Integration Point]
* xref:#ghpfm[`org.glassfish.admingui:resources` Integration Point]
* xref:#ghpiz[`org.glassfish.admingui:customtheme` Integration Point]
* xref:#ghppm[`org.glassfish.admingui:masthead` Integration Point]
* xref:#ghppk[`org.glassfish.admingui:loginimage` Integration Point]
* xref:#ghprk[`org.glassfish.admingui:loginform` Integration Point]
* xref:#ghpse[`org.glassfish.admingui:versioninfo` Integration Point]
