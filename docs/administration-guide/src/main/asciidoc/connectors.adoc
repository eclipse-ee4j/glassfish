...
xref:jdbc.adoc#ablih[Administering Database Connectivity].
...
the pool. For administration procedures, see xref:#ablls[Administering
...
administration procedures, see xref:#abllx[Administering Connector
Resources].
...
For administration procedures, see xref:#giope[Administering the
...
administration procedures, see xref:#giohl[Administering Connector Work
Security Maps].
...
administration procedures, see xref:#ablmc[Administering Administered
Objects].
...
* xref:#gjiqz[To Connect to (Ping) or Reset (Flush) a Connector
Connection Pool]
...
require server restart. See xref:overview.adoc#ghciy[Configuration
...
+
For instructions, see xref:jdbc.adoc#ggnwn[To Contact (Ping) a Connection
Pool].
...
xref:jdbc.adoc#ggnwn[To Contact (Ping) a Connection Pool] or
xref:jdbc.adoc#gjiqp[To Reset (Flush) a Connection Pool] for
instructions.
...
See xref:overview.adoc#ghciy[Configuration Changes That Require Restart].
If your server needs to be restarted, see xref:domains.adoc#ginqj[To Restart a Domain].
...
server restart. See xref:overview.adoc#ghciy[Configuration Changes That
Require Restart].

Before You Begin

Before creating a connector resource, you must first create a connector
connection pool. For instructions, see xref:#gioce[To Create a Connector
Connection Pool].
...
* xref:#gioqx[To Create Configuration Information for a Resource
Adapter]
...
connector connection pool. For instructions, see xref:#gioce[To Create a
Connector Connection Pool].
