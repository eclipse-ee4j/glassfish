...
reference_name::
  ...
  about module and application versions, see "xref:application-deployment-guide.adoc#module-and-application-versions[Module
...
xref:list-application-refs.adoc#list-application-refs[`list-application-refs`(1)],
