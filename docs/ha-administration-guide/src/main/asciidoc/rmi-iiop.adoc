...
"link:application-deployment-guide/dd-elements.html#client-container[client-container]" in {productName} Application Deployment Guide.
+
...
See link:session-persistence-and-failover.html#enabling-the-high-availability-session-persistence-service[Enabling the High
...
* "link:application-development-guide/ejb.html#beahl[Using Enterprise JavaBeans Technology]" in {productName} Application Development Guide
...
* "link:application-deployment-guide/deploying-applications.html#to-deploy-an-application-or-module[To Deploy an Application or Module]" in {productName} Application Deployment Guide
* "link:application-deployment-guide/deploying-applications.html#to-redeploy-an-application-or-module[To Redeploy an Application or Module]" in {productName} Application Deployment Guide
