...
deployment descriptors, see "link:application-deployment-guide/dd-elements.html#beaqi[Elements of the {productName} Deployment Descriptors]" in {productName}
...
see "link:application-deployment-guide/dd-elements.html#beaqi[Elements of the {productName} Deployment
...
loading in the {productName}, see xref:class-loaders.adoc#beade[Class
Loaders].
...
xref:webservices.adoc#gaszn[Developing Web Services].
...
"link:application-deployment-guide/dd-elements.html#beaqi[Elements of the {productName} Deployment
Descriptors]" in {productName} Application
Deployment Guide.
...
see "link:administration-guide/http_https.html#ablsw[Administering Internet Connectivity]" in {productName} Administration Guide.
