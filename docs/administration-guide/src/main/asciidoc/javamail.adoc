...
xref:reference-manual.adoc#create-javamail-resource[`create-javamail-resource`] subcommand.
+
...
xref:reference-manual.adoc#list-javamail-resources[`list-javamail-resources`] subcommand.
...
1. Ensure that the server is running. Remote subcommands require a running server.
2. List the JavaMail resources by using the
xref:reference-manual.adoc#list-javamail-resources[`list-javamail-resources`] subcommands.
3. Delete a JavaMail resource by using the
xref:reference-manual.adoc#delete-javamail-resource[`delete-javamail-resource`] subcommands.
