...
* xref:#testing-applications-with-the-maven-plug-in-for-embedded-glassfish-server[Running and Testing Applications with the Maven Plug-in for Embedded {productName}]
...
* With the Maven Plug-in (see xref:#testing-applications-with-the-maven-plug-in-for-embedded-glassfish-server[Running and Testing Applications with the
...
== Running and Testing Applications with the Maven Plug-in for Embedded {productName}
