...
## Current Release - 7.0.10 {#current}
...
* [Development version (7.0.11-SNAPSHOT)](docs#development)
* [5.1.0 release](docs#5.1.0)

## Jakarta EE Documentation {#jakarta-ee}

Eclipse GlassFish 7.0.10 provides the following Jakarta EE APIs:
...
Eclipse GlassFish 7.0.10 Web Profile provides the following Jakarta EE APIs:
...
Eclipse GlassFish 7.0.10 provides the following MicroProfile APIs:
...
Eclipse GlassFish 7.0.10 Web Profile doesn't provide any MicroProfile APIs.
