...
link:debugging-apps.html#application-client-debugging[Application Client Debugging].
...
Application clients can use link:securing-apps.html#programmatic-login-using-the-programmaticlogin-class[Programmatic
...
"link:application-deployment-guide/overview.html#deployment-descriptors-and-annotations[Deployment Descriptors and Annotations]" in {productName} Application Deployment Guide.
...
link:jndi.html#accessing-the-naming-context[Accessing the Naming Context]. +
...
see link:jndi.html#mapping-references[Mapping References].
...
"link:application-deployment-guide/dd-elements.html#target-server[target-server]" in {productName} Application Deployment Guide.
...
port number. See "link:application-deployment-guide/dd-elements.html#client-container[client-container]" in {productName} Application Deployment Guide. +
...
naming, see "link:application-deployment-guide/overview.html#naming-standards[Naming Standards]" in {productName} Application Deployment Guide.
...
domain keystore, see "link:security-guide/system-security.html#administering-jsse-certificates[Administering JSSE Certificates]"
...
certificate to the domain keystore, see "link:security-guide/system-security.html#administering-jsse-certificates[Administering
...
link:securing-apps.html#programmatic-login-using-the-programmaticlogin-class[Programmatic Login Using the
...
+
For more information on deployment, see "link:application-deployment-guide/overview.html#about-deployment-tools[About
...
+
For information on configuring JMS resources, see
"link:administration-guide/jms.html#administering-jms-connection-factories-and-destinations[
