...
* xref:#gkpcz[Using Application-Scoped JMS Resources]
* xref:#beaop[Load-Balanced Message Inflow]
* xref:#beaor[Authentication With `ConnectionFactory`]
* xref:#beaot[Delivering SOAP Messages Using the JMS API]
...
* xref:#beaou[To Send SOAP Messages Using the JMS API]
* xref:#beaov[To Receive SOAP Messages Using the JMS API]
