...
## Current Release - 7.0.12 {#current}
...
* [Development version (7.0.14-SNAPSHOT)](docs#development)
* [5.1.0 release](docs#5.1.0)

## Jakarta EE Documentation {#jakarta-ee}

Eclipse GlassFish 7.0.12 provides the following Jakarta EE APIs:
...
Eclipse GlassFish 7.0.12 Web Profile provides the following Jakarta EE APIs:
...
Eclipse GlassFish 7.0.12 provides the following MicroProfile APIs:
...
Eclipse GlassFish 7.0.12 Web Profile doesn't provide any MicroProfile APIs.
