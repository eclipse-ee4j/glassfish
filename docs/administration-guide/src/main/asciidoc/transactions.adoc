...
"https://jakarta.ee/learn/docs/jakartaee-tutorial/current/supporttechs/transactions/transactions.html[Transactions]"
...
xref:release-notes.adoc[{productName} Release Notes]. For
...
commands, see the xref:reference-manual.adoc#set[{productName}
