...
Custom realm::
  ...
  "link:application-development-guide/securing-apps.html#creating-a-custom-realm[
...
link:reference-manual/create-auth-realm.html#create-auth-realm[`create-auth-realm`] subcommand. +
...
"link:application-development-guide/securing-apps.html#creating-a-custom-realm[Creating a Custom Realm]" in {productName} Application Development Guide.
...
1. Ensure that the server is running. Remote subcommands require a running server.
2. List realms by using the link:reference-manual/list-auth-realms.html#list-auth-realms[`list-auth-realms`]
subcommand.
...
1. List realms by using the link:reference-manual/list-auth-realms.html#list-auth-realms[`list-auth-realms`]
subcommand.
...
link:reference-manual/list-auth-realms.html#list-auth-realms[`list-auth-realms`] subcommand.
3. If necessary, notify users that the realm is being deleted.
4. Delete the realm by using the
link:reference-manual/delete-auth-realm.html#delete-auth-realm[`delete-auth-realm`] subcommand.
...
See "link:administration-guide/jdbc.html#to-create-a-jdbc-connection-pool[
To Create a JDBC Connection Pool]" in {productName} Administration Guide.

4. Create a JDBC resource for the database. +
"link:administration-guide/jdbc.html#to-create-a-jdbc-resource[
...
"link:application-development-guide/securing-apps.html#how-to-configure-a-realm[
...
If needed, see "link:administration-guide/jdbc.html#to-start-the-database[To Start the Database]"
in {productName} Administration Guide.

9. To apply the authentication, restart the server. +
See "link:administration-guide/domains.html#to-restart-a-domain[To Restart a Domain]"
in {productName} Administration Guide.
...
See link:reference-manual/configure-ldap-for-admin.html#configure-ldap-for-admin[`configure-ldap-for-admin`] for more information
...
link:administrative-security.html#running-secure-admin[Running Secure Admin], you cannot
...
groups by using the
link:reference-manual/list-file-groups.html#list-file-groups[`list-file-groups`] subcommand.
...
link:reference-manual/asadmin.html#asadmin[`asadmin`(1M)] for more information.
...
1. Ensure that the server is running. Remote subcommands require a running server.
2. List users by using the link:reference-manual/list-file-users.html#list-file-users[`list-file-users`]
subcommand.
...
link:reference-manual/update-file-user.html#update-file-user[`update-file-user`] subcommand.
3. To apply your changes, restart {productName}. +
See "link:administration-guide/domains.html#to-restart-a-domain[To Restart a Domain]"
in {productName} Administration Guide.
...
link:reference-manual/list-file-users.html#list-file-users[`list-file-users`] subcommand.
3. Delete the user by using the
link:reference-manual/delete-file-user.html#delete-file-user[`delete-file-user`] subcommand.
