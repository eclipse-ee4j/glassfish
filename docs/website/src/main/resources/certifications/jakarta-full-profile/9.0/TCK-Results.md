...
# Eclipse GlassFish 6.0, Jakarta EE 9 TCK Certification Summary

- Product Name, Version and download URL (if applicable): <br/>
  [Eclipse GlassFish 6.0](https://eclipse-ee4j.github.io/glassfish/download)
  (https://download.eclipse.org/ee4j/glassfish/weekly/glassfish-6.0.0-SNAPSHOT-2020-10-25.zip)
- Specification Name, Version and download URL: <br/>
  [Jakarta EE Platform, 9.0](https://jakarta.ee/specifications/platform/9/)
- TCK Version, digital SHA-256 fingerprint and download URL: <br/>
  [Jakarta EE Platform TCK 9.0](https://download.eclipse.org/ee4j/jakartaee-tck/jakartaee9-eftl/staged-900/jakarta-jakartaeetck-9.0.0.zip), SHA-256: `661752b5c6c2e058b9ddb21b1ffbb36f9e99ad11fd51b8aa61bd10d6c235d308`
...
- Any Additional Specification Certification Requirements: <br/>
  ...
  Jakarta Batch 2.0 TCK tests are included in Jakarta EE 9 TCK tests, See Stage Name: jbatch <br/>
...
Stage Name: jaxrs
   [runcts] OUT => [javatest.batch] ********************************************************************************
   [runcts] OUT => [javatest.batch] Completed running 2804 tests.
   [runcts] OUT => [javatest.batch] Number of Tests Passed      = 2804
   [runcts] OUT => [javatest.batch] Number of Tests Failed      = 0
   [runcts] OUT => [javatest.batch] Number of Tests with Errors = 0
   [runcts] OUT => [javatest.batch] ********************************************************************************
