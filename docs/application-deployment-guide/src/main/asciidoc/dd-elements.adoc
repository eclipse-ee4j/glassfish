...
|`valve_n` |none a|
This property is deprecated. Use the xref:#valve[`valve`] subelement
instead.
...
JMS resources, see "link:application-development-guide/jms.html#beaob[Using the Java Message Service]" in
{productName} Application Development Guide.
...
"link:application-development-guide/java-clients.html#beakt[Developing Java Clients]" in {productName} Application Development Guide.
