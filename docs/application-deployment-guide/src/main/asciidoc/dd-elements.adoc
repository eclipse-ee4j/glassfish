...
in the Message Queue software), see the xref:{mq-admin-guide-url}[Open Message Queue
...
`--keepstate` option of the link:reference-manual/redeploy.html#redeploy[`redeploy`] subcommand
...
details, see link:reference-manual/create-virtual-server.html#create-virtual-server[`create-virtual-server`(1)].
