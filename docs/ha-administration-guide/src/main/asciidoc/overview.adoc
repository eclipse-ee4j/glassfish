...
selecting a topology, see the xref:deployment-planning-guide.adoc[{productName} Deployment Planning Guide]. This manual also provides a
...
of high availability features, see the xref:application-development-guide.adoc[{productName} Application Development Guide].
