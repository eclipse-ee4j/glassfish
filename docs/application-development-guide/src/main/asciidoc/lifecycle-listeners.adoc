...
* xref:#beamd[Server Life Cycle Events]
* xref:#beame[The LifecycleListener Interface]
* xref:#beamf[The `LifecycleEvent` Class]
* xref:#beamg[The Server Lifecycle Event Context]
* xref:#beamh[Deploying a Lifecycle Module]
* xref:#beami[Considerations for Lifecycle Modules]
