...
For more information about clusters, see the xref:ha-administration-guide.adoc[{productName} High Availability Administration Guide].
...
information about deployment, see the xref:application-deployment-guide.adoc[{productName} Application Deployment Guide].
