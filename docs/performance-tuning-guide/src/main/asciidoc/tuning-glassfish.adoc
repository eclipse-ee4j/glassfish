...
* xref:#gkxwm[Using the {productName} Performance Tuner]
* xref:#abedo[Deployment Settings]
* xref:#abeds[Logger Settings]
* xref:#abedw[Web Container Settings]
* xref:#abeea[EJB Container Settings]
* xref:#abeel[Java Message Service Settings]
* xref:#abeem[Transaction Service Settings]
* xref:#abeet[HTTP Service Settings]
* xref:#abegk[Network Listener Settings]
* xref:#gkxjt[Transport Settings]
* xref:#abehk[Thread Pool Settings]
* xref:#abegt[ORB Settings]
* xref:#abehp[Resource Settings]
* xref:#gkxvd[Load Balancer Settings]
...
* xref:#abedp[Disable Auto-Deployment]
* xref:#abedq[Use Pre-compiled JavaServer Pages]
* xref:#abedr[Disable Dynamic Application Reloading]
...
* xref:#abedx[Session Properties: Session Timeout]
* xref:#abedy[Manager Properties: Reap Interval]
* xref:#abedz[Disable Dynamic JSP Reloading]
...
* xref:#abeed[Overview of EJB Pooling and Caching]
* xref:#abeee[Tuning the EJB Pool]
* xref:#abeeg[Tuning the EJB Cache]
* xref:#abeei[Pool and Cache Settings for Individual EJB Components]
* xref:#abeej[Commit Option]
...
* xref:#abeen[Monitoring the Transaction Service]
* xref:#abeep[Tuning the Transaction Service]
...
* xref:#abeeu[Monitoring the HTTP Service]
* xref:#abefk[HTTP Service Access Logging]
...
* xref:#abeew[DNS Cache Information (dns)]
* xref:#abefh[File Cache Information (file-cache)]
* xref:#abefi[Keep Alive (keep-alive)]
* xref:#abefg[Connection Queue]
...
* xref:#abeex[Enabled]
* xref:#abeey[CacheEntries (CurrentCacheEntries / MaxCacheEntries)]
* xref:#abeez[HitRatio]
* xref:#abefa[Caching DNS Entries]
* xref:#abefb[Limit DNS Lookups to Asynchronous]
* xref:#abefc[Enabled]
* xref:#abefd[NameLookups]
* xref:#abefe[AddrLookups]
* xref:#abeff[LookupsInProgress]
...
For information about tuning the file cache, see xref:#gkxit[File Cache
Settings].
...
xref:#abefu[Timeout] for more information.
...
* xref:#abegl[General Settings]
* xref:#gkxjd[HTTP Settings]
* xref:#gkxit[File Cache Settings]
...
* xref:#abeft[Max Connections]
* xref:#abegd[DNS Lookup Enabled]
* xref:#abefu[Timeout]
* xref:#abefq[Header Buffer Length]
...
* xref:#abefn[Max Thread Pool Size]
* xref:#abefo[Min Thread Pool Size]
...
* xref:#abegu[Overview]
* xref:#abegv[How a Client Connects to the ORB]
* xref:#abegw[Monitoring the ORB]
* xref:#abegz[Tuning the ORB]
...
* xref:#abegx[Connection Statistics]
* xref:#abegy[Thread Pools]
...
* xref:#abeha[Tunable ORB Parameters]
* xref:#abehb[ORB Thread Pool Parameters]
* xref:#abehc[Client ORB Properties]
* xref:#abehg[Thread Pool Sizing]
* xref:#abehh[Examining IIOP Messages]
...
more information, see xref:#abehg[Thread Pool Sizing].
...
* xref:#abehd[Controlling Connections Between Client and Server ORB]
* xref:#CEGDGBBG[Limiting the Maximum Number of Client Connections]
* xref:#abehf[Load Balancing]
...
* xref:#abehq[JDBC Connection Pool Settings]
* xref:#abehy[Connector Connection Pool Settings]
...
* xref:#abehr[Monitoring JDBC Connection Pools]
* xref:#abehs[Tuning JDBC Connection Pools]
...
* xref:#abeht[Pool Size Settings]
* xref:#abehu[Timeout Settings]
* xref:#abehv[Isolation Level Settings]
* xref:#abehw[Connection Validation Settings]
...
section, xref:#abehs[Tuning JDBC Connection Pools].
