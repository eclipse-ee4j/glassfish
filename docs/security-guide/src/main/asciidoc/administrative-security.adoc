...
* xref:#gkocp[Secure Administration Overview]
* xref:#gkofl[How Secure Admin Works: The Big Picture]
* xref:#gkofe[Considerations When Running {productName} With Default Security]
* xref:#gkomz[Running Secure Admin]
* xref:#gkolu[Additional Considerations When Creating Local Instances]
* xref:#gkqah[Secure Admin Use Case]
* xref:#gkodn[Upgrading an SSL-Enabled Secure GlassFish Installation to Secure Admin]
...
* xref:#gkqce[Functions Performed by Secure Admin]
* xref:#gkocv[Which Administration Account is Used?]
* xref:#gkodi[What Authentication Methods Are Used for Secure Administration?]
* xref:#gkpex[Understanding How Certificate Authentication is Performed]
* xref:#gkoey[What Certificates Are Used?]
* xref:#glgmy[An Alternate Approach: Using Distinguished Names to Specify Certificates]
* xref:#gkqjj[Guarding Against Unwanted Connections]
...
** Configures SSL to use the administration keystore and the correct
   ...
   (You can use your own certificate instead, as described in xref:#gkped[
...
As described in xref:#gkped[Using Your Own Certificates], you can
