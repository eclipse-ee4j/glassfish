...
xref:jms.adoc#abdbk[Configuring Java Message Service High Availability]
and xref:rmi-iiop.adoc#fxxqs[RMI-IIOP Load Balancing and Failover].
...
xref:rolling-upgrade.adoc#abdik[Upgrading Applications Without Loss of Availability].
