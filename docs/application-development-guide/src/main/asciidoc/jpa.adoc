...
1. Set up the datasource. See "link:administration-guide/jdbc.html#administering-database-connectivity[
...
7. Monitor the application. See "link:administration-guide/monitoring.html#administering-the-monitoring-service[
