...
DCOM to connect to the host, see link:ssh-setup.html#to-test-the-connection-over-dcom-to-a-remote-host[To Test the
...
information about this file, see link:ssh-setup.html#to-set-up-password-authentication-for-the-windows-user[To Set Up
...
* link:instances.html#to-create-an-instance-centrally[To Create an Instance Centrally]
...
* link:instances.html#to-delete-an-instance-centrally[To Delete an Instance Centrally]
* link:instances.html#to-delete-an-instance-locally[To Delete an Instance Locally]
...
authentication, see link:ssh-setup.html#setting-up-ssh-user-authentication[Setting Up SSH User
Authentication].
====
+
[source]
...
information, see link:instances.html#to-create-an-instance-locally[To Create an Instance Locally].
====
...
After creating a node, you can create instances on the node as explained
in link:instances.html#to-create-an-instance-locally[To Create an Instance Locally].
...
resides on a `CONFIG` node, see link:instances.html#to-delete-an-instance-locally[To Delete an
Instance Locally].
