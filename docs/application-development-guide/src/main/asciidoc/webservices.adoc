...
"https://jakarta.ee/learn/docs/jakartaee-tutorial/current/websvcs/xml-websvcs/xml-websvcs.html[Web Services]"
...
commands, see "https://jakarta.ee/learn/docs/jakartaee-tutorial/current/websvcs/xml-websvcs/xml-websvcs.html[
...
descriptors, see the xref:application-deployment-guide.adoc[
{productName} Application Deployment Guide].
For more information about the
`asadmin deploy` command, see the xref:reference-manual.adoc#deploy[
...
information, see the xref:application-deployment-guide.adoc[{productName}
