...
`--properties`::
  ...
  `GMS_DISCOVERY_URI_LIST`;;
    ...
    ** port is the port number of the port on which the instance listens
    ...
    see "xref:ha-administration-guide.adoc#discovering-a-cluster-when-multicast-transport-is-unavailable[Discovering a Cluster When Multicast Transport
...
"xref:ha-administration-guide.adoc#discovering-a-cluster-when-multicast-transport-is-unavailable[Discovering a Cluster When Multicast Transport Is
