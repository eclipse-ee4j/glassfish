...
## <a name="current">Current Release - 7.0.6</a>
...
Eclipse GlassFish 7.0.6 provides the following Jakarta EE APIs:
...
Eclipse GlassFish 7.0.6 Web Profile provides the following Jakarta EE APIs:
...
Eclipse GlassFish 7.0.6 provides the following MicroProfile APIs:
...
Eclipse GlassFish 7.0.6 Web Profile doesn't provide any MicroProfile APIs.
