...
We are pleased to announce that with the milestone Release 9.0.0-M8, Eclipse GlassFish is officially certified as a Jakarta EE 10 compatible implementation.
