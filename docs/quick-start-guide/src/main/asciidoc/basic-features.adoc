...
* xref:#ghgpe[About This Quick Start Guide]
* xref:#default-paths-and-file-names[Default Paths and File Names]
* xref:#gixue[Default Administration Values]
* xref:#gglog[Starting and Stopping the Default Domain]
* xref:#gglmh[Starting and Stopping the Database Server]
* xref:#ggllq[Starting the Administration Console]
* xref:#geyvr[Deploying and Undeploying Applications]
* xref:#gktqx[High Availability Clustering and Load Balancing]
* xref:#ggkzh[For More Information]
...
guide, see xref:#ggkzh[For More Information].
...
* xref:#ghgis[To Obtain the Sample Application]
* xref:#gkpao[Deploying and Undeploying the Sample Application From the Command Line]
* xref:#gkpau[Deploying and Undeploying Applications by Using the Administration Console]
* xref:#gkpaa[Deploying and Undeploying the Sample Application Automatically]
...
* xref:#ggndq[To Deploy the Sample Application From the Command Line]
* xref:#ggnco[To List Deployed Applications From the Command Line]
* xref:#ggnbm[To Undeploy the Sample Application From the Command Line]
...
download the sample, see xref:#ghgis[To Obtain the Sample Application].
...
* xref:#ggnbn[To Deploy the Sample Application by Using the Administration Console]
* xref:#ggncd[To View Deployed Applications in the Administration Console]
* xref:#ggneh[To Undeploy the Sample Application by Using the Administration Console]
...
To download the sample, see xref:#ghgis[To Obtain the Sample Application].
At least one {productName} domain must be started before you deploy
the sample application.
...
* xref:#geyvj[To Deploy the Sample Application Automatically]
* xref:#ggncw[To Undeploy the Sample Application Automatically]
...
* xref:#ghhir[Product Documentation]
* xref:#giyjo[Tutorials]
* xref:#gintm[Jakarta EE Examples]
