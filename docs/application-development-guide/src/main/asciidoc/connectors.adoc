...
https://jakarta.ee/learn/docs/jakartaee-tutorial/current/supporttechs/connectors/connectors.html[
...
the xref:application-deployment-guide.adoc[
...
xref:reference-manual.adoc#create-threadpool[{productName} Reference Manual].
...
xref:reference-manual.adoc#create-resource-adapter-config[{productName} Reference Manual].
...
see the xref:reference-manual.adoc#create-connector-security-map[{productName} Reference
Manual].
...
the xref:reference-manual.adoc#create-connector-work-security-map[{productName} Reference Manual].
...
details, see the xref:reference-manual.adoc#create-resource-adapter-config[{productName}
Reference Manual].
...
xref:reference-manual.adoc#ping-connection-pool[{productName} Reference Manual].
...
information, see the xref:reference-manual.adoc#create-connector-connection-pool[{productName}
Reference Manual].
...
xref:reference-manual.adoc#flush-connection-pool[{productName} Reference Manual].
...
For details, see the xref:reference-manual.adoc#set[{productName}
Reference Manual].
