...
* xref:#hk2-component-model[HK2 Component Model]
* xref:#services-in-the-hk2-component-model[Services in the HK2 Component Model]
* xref:#hk2-runtime[HK2 Runtime]
* xref:#inversion-of-control[Inversion of Control]
* xref:#identifying-a-class-as-an-add-on-component[Identifying a Class as an Add-On Component]
* xref:#using-the-apache-maven-build-system-to-develop-hk2-components[Using the Apache Maven Build System to Develop HK2 Components]
