...
<map>
 <entry key="extraProperties">
  <map>
   ...
   <entry key="entity">
    <map>
     <entry key="installDir" value="/export/glassfish9"/>
...
<records>
 ...
 productName="glassfish9" recordNumber="473"/>
</records>
----
