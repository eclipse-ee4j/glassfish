...
* xref:#ghpuj[About the Administrative Command Infrastructure of {productName}]
* xref:#ghpwe[Adding an `asadmin` Subcommand]
* xref:#ghpwa[Adding Parameters to an `asadmin` Subcommand]
* xref:#gkygt[Making `asadmin` Subcommands Cluster-Aware]
* xref:#ghptw[Adding Message Text Strings to an `asadmin` Subcommand]
* xref:#ghpvn[Enabling an `asadmin` Subcommand to Run]
* xref:#ghpvq[Setting the Context of an `asadmin` Subcommand]
* xref:#ghpwn[Changing the Brand in the {productName} CLI]
* xref:#ghmza[Examples of Extending the `asadmin` Utility]
* xref:#gkzlq[Implementing Create, Delete, and List Commands Using
Annotations]
...
* xref:#ghrqj[Representing an `asadmin` Subcommand as a Java Class]
* xref:#ghrpm[Specifying the Name of an `asadmin` Subcommand]
* xref:#ghrng[Ensuring That an `AdminCommand` Implementation Is
Stateless]
* xref:#ghrqx[Example of Adding an `asadmin` Subcommand]
...
* xref:#ghpvh[Representing a Parameter of an `asadmin` Subcommand]
* xref:#ghptx[Identifying a Parameter of an `asadmin` Subcommand]
* xref:#ghpxp[Specifying Whether a Parameter Is an Option or an Operand]
* xref:#ghpxj[Specifying the Name of an Option]
* xref:#ghpxl[Specifying the Acceptable Values of a Parameter]
* xref:#ghrgt[Specifying the Default Value of a Parameter]
* xref:#ghpuk[Specifying Whether a Parameter Is Required or Optional]
* xref:#CDCFAJDG[Specifying Whether a Parameter Can Be Used Multiple
Times on the Command Line]
* xref:#ghpxd[Example of Adding Parameters to an `asadmin` Subcommand]
...
* xref:#gkyjk[Specifying Allowed Targets]
* xref:#gkykm[The `Target` Utility]
* xref:#gkyfv[Specifying `asadmin` Subcommand Execution]
* xref:#gkyjs[Subcommand Preprocessing and Postprocessing]
* xref:#gkyit[Running a Command from Another Command]
...
in xref:#gkyfv[Specifying `asadmin` Subcommand Execution].
...
* xref:#gkzkc[Command Patterns]
* xref:#gkzle[Resolvers]
* xref:#gkzoy[The `@Create` Annotation]
* xref:#gkzoo[The `@Delete` Annotation]
* xref:#gkzpl[The `@Listing` Annotation]
* xref:#gkznf[Create Command Decorators]
* xref:#gkznx[Delete Command Decorators]
* xref:#gkzmu[Specifying Command Execution]
* xref:#gkznd[Using Multiple Command Annotations]
