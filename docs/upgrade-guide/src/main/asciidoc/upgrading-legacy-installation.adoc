...
Target Root Domain's Directory::
  ...
  upgrading (for example, `c:\glassfish8\glassfish\domains`).
Master Password::
...
-t /home/glassfish8/glassfish/domains
----
...
`c:\glassfish8\glassfish\domains`).
...
software on the host, for example, `/export/glassfish8`. +
