...
"link:application-deployment-guide/dd-elements.html#cache-mapping[cache-mapping]" in {productName} Application Deployment Guide and "link:../application-deployment-guide/dd-elements.html#dispatcher[dispatcher]"
...
"link:application-deployment-guide/dd-elements.html#cache[cache]" in {productName}
...
"link:application-deployment-guide/dd-elements.html#default-helper[default-helper]" in {productName} Application Deployment Guide.
...
"link:application-deployment-guide/dd-elements.html#session-properties[session-properties]" in {productName} Application Deployment Guide and
"link:application-deployment-guide/dd-elements.html#cookie-properties[cookie-properties]" in {productName} Application Deployment Guide.
...
link:jndi.html#accessing-the-naming-context[Accessing the Naming Context]. For more information
...
Objects, see "link:administration-guide/jms.html#administering-jms-physical-destinations[Administering JMS Physical Destinations]"
...
For more information, see "link:application-deployment-guide/dd-elements.html#session-manager[session-manager]" in
...
"link:application-deployment-guide/dd-elements.html#manager-properties[manager-properties]" in {productName} Application Deployment Guide. The `sessionFilename` property
...
information about `server.policy`, see link:securing-apps.html#GSDVG00121[The
`server.policy` File].
====
...
under "link:application-deployment-guide/dd-elements.html#manager-properties[manager-properties]" in {productName} Application Deployment Guide except `sessionFilename`,
and supports the `directory` store property listed under
"link:application-deployment-guide/dd-elements.html#store-properties[store-properties]" in {productName} Application Deployment Guide.
...
listed under "link:application-deployment-guide/dd-elements.html#manager-properties[manager-properties]" in {productName} Application Deployment Guide except
`sessionFilename`, and supports the `persistenceScope` store property
listed under "link:application-deployment-guide/dd-elements.html#store-properties[store-properties]" in {productName} Application Deployment Guide.
...
"link:application-deployment-guide/dd-elements.html#parameter-encoding[parameter-encoding]" in {productName} Application Deployment Guide.
...
application. For details, see "link:application-deployment-guide/dd-elements.html#glassfish-web-app[glassfish-web-app]" in
{productName} Application Deployment Guide.
...
For details, see "link:application-deployment-guide/dd-elements.html#idempotent-url-pattern[idempotent-url-pattern]" in {productName} Application Deployment Guide.
...
elements, see "link:application-deployment-guide/dd-elements.html#glassfish-web-app[glassfish-web-app]" in {productName} Application Deployment Guide.
...
link:securing-apps.html#enabling-and-disabling-the-security-manager[Enabling and Disabling the Security
Manager].
