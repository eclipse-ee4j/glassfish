...
link:packaging-integrating-delivering.html#integrating-an-add-on-component-with-glassfish-server[Integrating an Add-On Component With {productName}].
...
link:adding-configuration-data.html#creating-a-transaction-to-update-configuration-data[Creating a Transaction to
...
link:adding-container-capabilities.html#example-of-adding-container-capabilities[Example of Adding Container
Capabilities].
