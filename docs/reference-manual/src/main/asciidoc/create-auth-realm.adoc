...
--
  ...
  * You can specify the following properties for `CertificateRealm`:
  ...
  `LoginModule`;;
    ...
    information, see "link:security-guide/system-security.html#custom-authentication-of-client-certificate-in-ssl-mutual-authentication[Custom Authentication of Client
