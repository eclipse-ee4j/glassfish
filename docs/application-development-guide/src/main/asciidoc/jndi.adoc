...
xref:reference-manual.adoc#create-jvm-options[{productName} Reference Manual].
...
xref:reference-manual.adoc#create-jndi-resource[{productName} Reference Manual].
...
command. For details, see the xref:reference-manual.adoc#create-custom-resource[{productName} Reference Manual].
