...
link:freeze-transaction-service.html#freeze-transaction-service[`freeze-transaction-service`(1)],
link:rollback-transaction.html#rollback-transaction[`rollback-transaction`(1)],
link:unfreeze-transaction-service.html#unfreeze-transaction-service[`unfreeze-transaction-service`(1)]

"link:administration-guide/transactions.html#ablsn[Administering Transactions]"
