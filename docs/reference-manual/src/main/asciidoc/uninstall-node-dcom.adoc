...
host. The entire content of the `C:\glassfish8` directory is removed.

[source]
----
asadmin> uninstall-node-dcom --force --installdir C:\glassfish8 xkyd.example.com
Command uninstall-node-dcom executed successfully.
----
