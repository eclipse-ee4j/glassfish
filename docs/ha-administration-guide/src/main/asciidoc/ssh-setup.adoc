...
|DCOM
|link:nodes.html#creating-listing-testing-and-deleting-dcom-nodes[Creating, Listing, Testing, and Deleting `DCOM` Nodes]
|link:instances.html#administering-glassfish-server-instances-centrally[Administering {productName} Instances Centrally]

|SSH
|link:nodes.html#creating-listing-testing-and-deleting-ssh-nodes[Creating, Listing, Testing, and Deleting `SSH` Nodes]
|link:instances.html#administering-glassfish-server-instances-centrally[Administering {productName} Instances Centrally]

|None
|link:nodes.html#creating-listing-and-deleting-config-nodes[Creating, Listing, and Deleting `CONFIG` Nodes]
|link:instances.html#administering-glassfish-server-instances-locally[Administering {productName} Instances Locally]
|===
...
link:nodes.html#to-create-a-dcom-node[To Create a `DCOM` Node] and
