...
This example runs the link:reference-manual/list-applications.html#list-applications[`list-applications`] subcommand
...
link:reference-manual/list-commands.html#list-commands[`list-commands`] subcommand. Local subcommands are
...
* Use the link:reference-manual/multimode.html#multimode[`multimode`] subcommand.
...
2. Run the link:reference-manual/multimode.html#multimode[`multimode`] subcommand, specifying the
...
* link:reference-manual/delete-domain.html#delete-domain[`delete-domain`(1)]
* link:reference-manual/list-commands.html#list-commands[`list-commands`(1)]
* link:reference-manual/multimode.html#multimode[`multimode`(1)]
...
* link:reference-manual/attach.html#attach[`attach`(1)]
* link:reference-manual/configure-managed-jobs.html#configure-managed-jobs[`configure-managed-jobs`(1)]
* link:reference-manual/list-jobs.html#list-jobs[`list-jobs`(1)]
...
link:reference-manual/create-system-properties.html#create-system-properties[`create-system-properties`] subcommand.
+
...
link:reference-manual/list-system-properties.html#list-system-properties[`list-system-properties`] subcommand.
+
...
link:reference-manual/delete-system-property.html#delete-system-property[`delete-system-property`] subcommand.
...
the link:reference-manual/create-jdbc-resource.html#create-jdbc-resource[`create-module-config`] subcommand.
...
link:reference-manual/create-jdbc-resource.html#create-jdbc-resource[`delete-module-config`] subcommand.
...
link:reference-manual/add-resources.html#add-resources[`add-resources`] subcommand.
+
Information about properties for the subcommand is included in this help
page.
...
1. Ensure that the server is running. Remote subcommands require a running server.
2. Display the version by using the link:reference-manual/version.html#version[`version`]
subcommand.
...
1. Ensure that the server is running. Remote subcommands require a running server.
2. List applications by using the link:reference-manual/list-applications.html#list-applications[`list-applications`]
subcommand.
...
1. Ensure that the server is running. Remote subcommands require a running server.
2. List containers by using the link:reference-manual/list-containers.html#list-containers[`list-containers`]
subcommand.
...
1. Ensure that the server is running. Remote subcommands require a running server.
2. List modules by using the link:reference-manual/list-modules.html#list-modules[`list-modules`]
subcommand.
...
1. Ensure that the server is running. Remote subcommands require a running server.
2. List subcommands by using the link:reference-manual/list-commands.html#list-commands[`list-commands`]
subcommand.
...
1. Ensure that the server is running. Remote subcommands require a running server.
2. List timers by using the link:reference-manual/list-timers.html#list-timers[`list-timers`] subcommand.
...
* The link:reference-manual/dotted-names.html#dotted-names[`dotted-names`(5ASC)] help page
...
* "link:security-guide/user-security.html#to-create-an-authentication-realm[To Create an Authentication Realm]" in {productName} Security Guide
* "link:security-guide/user-security.html#to-create-a-file-user[To Create a File User]" in {productName} Security Guide
