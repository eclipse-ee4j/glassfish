...
directory of the {productName} software is `C:\glassfish8`.
...
software on this host is `C:\middleware\glassfish8`.

[source]
----
asadmin> create-node-dcom --installdir C:\middleware\glassfish8
