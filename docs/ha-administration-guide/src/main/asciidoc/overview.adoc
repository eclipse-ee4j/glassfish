...
xref:session-persistence-and-failover.adoc#abdkz[Configuring High
...
xref:rmi-iiop.adoc#fxxqs[RMI-IIOP Load Balancing and Failover].
...
For more information, see xref:ssh-setup.adoc#gkshg[Enabling Centralized
