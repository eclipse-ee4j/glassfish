...
example, in the link:set.html#set[`set`(1)] subcommand, the value that
...
link:create-jvm-options.html#create-jvm-options[`create-jvm-options`(1)]
...
link:restart-domain.html#restart-domain[`restart-domain`(1)] subcommand.
...
link:start-domain.html#start-domain[`start-domain`(1)] subcommand,
type:
...
link:list-commands.html#list-commands[`list-commands`(1)] subcommand.
...
--
  ...
  * ``AS_ADMIN_WINDOWSPASSWORD=``windows-password (read by the
  ...
  and link:update-node-ssh.html#update-node-dcom[``update-node-dcom``(1)]
  subcommands)
  ...
  * ``AS_ADMIN_JMSDBPASSWORD=`` jdbc-user-password (read by the
  link:configure-jms-cluster.html#configure-jms-cluster[``configure-jms-cluster``(1)]
  subcommand)
--
...
`--detach`::
  ...
  link:list-jobs.html#list-jobs[`list-jobs`(1)] subcommand to view the
  jobs and their job IDs, the link:attach.html#attach[`attach`(1)]
...
link:list-jobs.html#list-jobs[`list-jobs`(1)],
link:login.html#login[`login`(1)],
link:restart-domain.html#restart-domain[`restart-domain`(1)],
link:set.html#set[`set`(1)],
link:set-web-env-entry.html#set-web-env-entry[`set-web-env-entry`(1)],
