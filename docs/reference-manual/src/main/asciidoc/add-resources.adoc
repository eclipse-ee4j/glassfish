...
link:create-jdbc-connection-pool.html#create-jdbc-connection-pool[`create-jdbc-connection-pool`(1)],link:create-jdbc-resource.html#create-jdbc-resource[`create-jdbc-resource`(1)],
...
link:create-custom-resource.html#create-custom-resource[`create-custom-resource`(1)],
link:create-connector-resource.html#create-connector-resource[`create-connector-resource`(1)],
