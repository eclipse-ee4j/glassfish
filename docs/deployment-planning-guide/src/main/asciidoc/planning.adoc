...
more information, see "link:{mq-admin-guide-url}/broker-clusters.html#GMADG00041[Configuring and Managing Broker
...
"link:{mq-admin-guide-url}/broker-clusters.html#GMADG00041[Configuring and Managing Broker Clusters]" in Open
...
+
For more information on these commands, see the xref:reference-manual.adoc[{productName} Reference Manual] or the corresponding man pages.
