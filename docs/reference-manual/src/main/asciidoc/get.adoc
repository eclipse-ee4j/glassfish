...
You can use the xref:list.adoc#list[`list`(1)] subcommand to display
...
using the xref:set.adoc#set[`set`(1)] subcommand. For more detailed
...
xref:list.adoc#list[`list`(1)], xref:set.adoc#set[`set`(1)]
