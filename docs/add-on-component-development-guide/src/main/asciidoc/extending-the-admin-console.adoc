...
* xref:#ghmof[Administration Console Architecture]
* xref:#ghmom[About Administration Console Templates]
* xref:#ghmqr[About Integration Points]
* xref:#ghmpg[Specifying the ID of an Add-On Component]
* xref:#ghmpk[Adding Functionality to the Administration Console]
* xref:#ghmqi[Adding Internationalization Support]
* xref:#ghmqg[Changing the Theme or Brand of the Administration Console]
* xref:#ghpkz[Creating an Integration Point Type]
...
`console-config.xml` file is described in xref:#ghmqr[About Integration
Points].
...
* xref:#ghoej[Creating a Jakarta Server Faces Page for Your Node]
* xref:#ghovg[Creating Jakarta Server Faces Pages for Your Tabs]
* xref:#ghoeu[Creating a Jakarta Server Faces Page for Your Task]
* xref:#ghoya[Creating a Jakarta Server Faces Page for Your Task Group]
* xref:#ghpao[Creating a Jakarta Server Faces Page for Your Page Content]
* xref:#ghmqe[Adding a Page to the Administration Console]
...
resources and pages in your add-on component. See xref:#ghocf[Adding a
...
* xref:#ghocf[Adding a Node to the Navigation Tree]
* xref:#ghotv[Adding Tabs to a Page]
* xref:#ghmqw[Adding a Task to the Common Tasks Page]
* xref:#ghozn[Adding a Task Group to the Common Tasks Page]
* xref:#ghmrg[Adding Content to a Page]
* xref:#ghmqe[Adding a Page to the Administration Console]
...
`url`::
  ...
  xref:#ghmpg[Specifying the ID of an Add-On Component]). The rest of
...
See xref:#ghozn[Adding a Task Group to the Common Tasks Page] for
