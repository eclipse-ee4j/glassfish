...
public final class Globals {
    ...
    /**
     * The request attribute under which we store the array of X509Certificate objects representing the certificate chain
     * presented by our client, if any.
     */
    ...
    /**
     * The request attribute under which we store the name of the cipher suite being used on an SSL connection (as an object
     * of type java.lang.String).
     */
    public static final String CIPHER_SUITE_ATTR = "jakarta.servlet.request.cipher_suite";

    /**
     * The servlet context attribute under which we store the class loader used for loading servlets (as an object of type
    ...
    /**
     * The servlet context attribute under which we store the class path for our application class loader (as an object of
     * type String), delimited with the appropriate path delimiter for this platform.
     */
    ...
    /**
     * The request attribute under which we expose the value of the <code>&lt;jsp-file&gt;</code> value associated with this
     * servlet, if any.
     */
    ...
    /**
     * The request attribute under which we store the session id being used for this SSL connection (as an object of type
     * java.lang.String).
     */
    public static final String SSL_SESSION_ID_ATTR = "jakarta.servlet.request.ssl_session_id";

    /**
     * The servlet context attribute under which the managed bean Registry will be stored for privileged contexts (if
     * enabled).
     */
    ...
    public static final String SESSION_VERSION_PARAMETER = ";" + SESSION_VERSION_PARAMETER_NAME + "=";
    ...
    public static final String JREPLICA_PARAMETER = ";" + JREPLICA_PARAMETER_NAME + "=";
    public static final String JREPLICA_SESSION_NOTE = "com.sun.enterprise.http.jreplicaLocation";
    public static final String WRAPPED_REQUEST = "__jakarta.security.auth.message.request";
    public static final String WRAPPED_RESPONSE = "__jakarta.security.auth.message.response";

    /**
     * The servlet context attribute under which we store a flag used to mark this request as having been processed by the
     * SSIServlet. We do this because of the pathInfo mangling happening when using the CGIServlet in conjunction with the
     * SSI servlet. (value stored as an object of type String)
     */
