...
# Jakarta EE Platform Web Profile 9.1, Eclipse GlassFish Web Profile 6.1, Certification Summary

- Product Name, Version and download URL (if applicable): <br/>
  [Eclipse GlassFish Downloads](/glassfish/download)<br/>
  [web-6.1.0.zip](https://download.eclipse.org/ee4j/glassfish/web-6.1.0.zip)
...
- Public URL of TCK Results Summary: <br/>
  [TCK results summary](TCK-Results-6.1)
...
```
    ...
    [junit] Tests run: 50, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.104 sec
```
...
TCK Result Summary:
```
 [mvn.test] Tests run: 1665, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 3,492.151 sec
 [mvn.test] 
 [mvn.test] Results :
 [mvn.test] 
 [mvn.test] Tests run: 1665, Failures: 0, Errors: 0, Skipped: 0
```
...
TCK Result Summary:
```
 [mvn.test] Tests run: 1045, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 702.767 sec - in TestSuite
 [mvn.test] 
 [mvn.test] Results :
 [mvn.test] 
