...
* xref:#gkshz[About Centralized Administration of {productName} Instances]
* xref:#CEGIFJJF[Setting Up DCOM and Testing the DCOM Set Up]
* xref:#gksiy[Setting Up Cygwin SSH on Windows]
* xref:#gkskf[Setting Up the MKS Toolkit on Windows]
* xref:#gksja[Setting Up SSH on UNIX and Linux Systems]
* xref:#gkslw[Testing the SSH Setup on a Host]
* xref:#gkshh[Setting Up SSH User Authentication]
* xref:#gkshn[Installing and Removing {productName} Software on Multiple Hosts]
...
xref:#CEGCDCEF[To Set Up Password Authentication for the Windows User].
...
in xref:#CEGDAFHD[Windows Operating System Settings].
* The Windows user is able to run scripts on the host. For more
information, see xref:#CEGCJGCF[To Enable the Windows User to Run
...
Test the DCOM setup as explained in xref:#CEGJFADH[To Test the
...
information about this file, see xref:#CEGCDCEF[To Set Up Password
...
* xref:#CEGDAFHD[Windows Operating System Settings]
* xref:#CEGCJGCF[To Enable the Windows User to Run Scripts on a Remote Host]
* link:nodes.html#CHDIGBJB[To Create a `DCOM` Node]
* link:instances.html#gkqch[To Create an Instance Centrally]
...
* xref:#gksjn[To Download and Install Cygwin]
* xref:#gksin[To Set the Path for Windows and for the Cygwin Shell]
* xref:#gksov[To Set the Home Directory for the Cygwin SSH User]
* xref:#gkskx[To Configure and Start the Cygwin SSH Server Daemon
`sshd`]
...
the host as explained in xref:#gkslw[Testing the SSH Setup on a Host].
...
* xref:#gksmq[To Install the MKS Toolkit]
* xref:#gksmu[To Set the Path for Windows and for the MKS Toolkit Shell]
* xref:#gksox[To Set the Home Directory for the MKS Toolkit SSH User]
* xref:#gksnx[To Configure and Start the MKS Toolkit SSH Server Daemon
`sshd`]
...
* xref:#gksjx[To Set Up SSH on Oracle Solaris Systems]
* xref:#gkspz[To Set Up SSH on MacOS Systems]
* xref:#gksrd[To Set Up SSH on Linux systems]
...
* xref:#gkskx[To Configure and Start the Cygwin SSH Server Daemon `sshd`]
* xref:#gksnx[To Configure and Start the MKS Toolkit SSH Server Daemon `sshd`]
* xref:#gksjx[To Set Up SSH on Oracle Solaris Systems]
...
information, see xref:#gkshh[Setting Up SSH User Authentication].
...
* xref:#gksqe[To Set Up Public Key Authentication Without Encryption]
* xref:#gktaq[To Set Up Encrypted Public Key Authentication]
* xref:#gktbd[To Set Up Password Authentication]
...
xref:#gksil[To Copy a {productName} Installation to Multiple Hosts].
...
xref:#gktaw[To Remove {productName} Software From Multiple Hosts].
