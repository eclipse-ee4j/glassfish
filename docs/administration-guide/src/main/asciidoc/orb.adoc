...
link:reference-manual/create-iiop-listener.html#create-iiop-listener[`create-iiop-listener`] subcommand.
+
...
link:reference-manual/list-iiop-listeners.html#list-iiop-listeners[`list-iiop-listeners`] subcommand.
...
link:reference-manual/delete-iiop-listener.html#delete-iiop-listener[`delete-iiop-listener`] subcommand.
