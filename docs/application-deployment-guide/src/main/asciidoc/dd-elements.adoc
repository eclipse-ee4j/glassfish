...
unique within a server instance. See the xref:ha-administration-guide.adoc[{productName} High Availability Administration Guide] for more
...
For more information about JNDI, see the xref:application-development-guide.adoc[{productName} Application Development Guide].
